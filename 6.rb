...
# Также вывести итоговую сумму за каждый товар.                                                                                                                                                                                                                                                                      Заполнить и вывести на экран хеш, ключами которого являются названия товаров, а значением - вложенный хеш, содержащий цену за единицу товара и кол-во купленного товара. Также вывести итоговую сумму за каждый товар.
...
loop do
  ...
  (puts "Name #{name} already exists!"; next) if cheque.keys.include?(name)
  ...
  cheque[name] = {price: price, count: count, amount: price*count}
  sum += price*count
end
